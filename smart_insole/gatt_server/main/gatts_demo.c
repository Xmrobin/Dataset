...
static void ADC__task(void *pvParameters)
{
    while (1)
    {
        ...
        adc2_get_raw(ADC2_CHANNEL_5,ADC_WIDTH_12Bit,&adc2_5_read_raw);
        adc2_get_raw(ADC2_CHANNEL_4,ADC_WIDTH_12Bit,&adc2_4_read_raw);
...
void app_main(void)
{
    ...
    while (1)
    {
        ...
        BLEReadDataBuff[0] = (adc_reading_0>>8)&0xFF;
        BLEReadDataBuff[1] = adc_reading_0&0xFF;
        BLEReadDataBuff[2] = (adc_reading_3>>8)&0xFF;
        BLEReadDataBuff[3] = adc_reading_3&0xFF;
        BLEReadDataBuff[4] = (adc_reading_4>>8)&0xFF;
        BLEReadDataBuff[5] = adc_reading_4&0xFF;
        BLEReadDataBuff[6] = (adc_reading_5>>8)&0xFF;
        BLEReadDataBuff[7] = adc_reading_5&0xFF;
        BLEReadDataBuff[8] = (adc_reading_6>>8)&0xFF;
        BLEReadDataBuff[9] = adc_reading_6&0xFF;
        BLEReadDataBuff[10] = (adc_reading_7>>8)&0xFF;
        BLEReadDataBuff[11] = adc_reading_7&0xFF;
        BLEReadDataBuff[12] = (adc2_5_read_raw>>8)&0xFF;
        BLEReadDataBuff[13] = adc2_5_read_raw&0xFF;
        BLEReadDataBuff[14] = (adc2_4_read_raw>>8)&0xFF;
        BLEReadDataBuff[15] = adc2_4_read_raw&0xFF;
